...
int main(int argc, char* argv[])
{
    ...
    omnithing.loadJsonConfig("{\"InputBools\": [{\"type\": \"DigitalInputPinStub\", \"pin\": 12, \"invertLogic\": true}], \"Devices\": [{\"type\": \"ContactSensor\", \"inputIndex\": 0, \"invert\": false, \"constantPoll\": true}], \"Triggers\": [{\"deviceIndex\": 0, \"interval\": 2000, \"command\": \"poll\"}] }");

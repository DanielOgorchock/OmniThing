 ...
 *    Date        Who            What
 *    ----        ---            ----
 *    2018-09-12  Dan Ogorchock  Added support for Hubitat
 */

metadata {
	definition (name: "omni_parent_hubitat", namespace: "OmniThing", author: "Daniel Ogorchock") {
...
private void createChildDevice(String name, String type) {
    ...
    try{
        if (state.hubType == "SMARTTHINGS") {
            ...
            addChildDevice("child_${type}", "${device.deviceNetworkId}_${name}",
